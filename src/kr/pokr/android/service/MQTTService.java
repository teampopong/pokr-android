package kr.pokr.android.service;
...
import kr.pokr.android.MainActivity;
...
public class MQTTService extends Service implements MqttSimpleCallback
{
    ...
    public static final String APP_ID = "kr.pokr.android";

    // constants used to notify the Activity UI of received messages
    public static final String MQTT_MSG_RECEIVED_INTENT = "kr.pokr.android.mqtt.MSGRECVD";
    public static final String MQTT_MSG_RECEIVED_TOPIC  = "kr.pokr.android.mqtt.MSGRECVD_TOPIC";
    public static final String MQTT_MSG_RECEIVED_MSG    = "kr.pokr.android.mqtt.MSGRECVD_MSGBODY";

    // constants used to tell the Activity UI the connection status
    public static final String MQTT_STATUS_INTENT = "kr.pokr.android.mqtt.STATUS";
    public static final String MQTT_STATUS_MSG    = "kr.pokr.android.mqtt.STATUS_MSG";

    // constant used internally to schedule the next ping event
    public static final String MQTT_PING_ACTION = "kr.pokr.android.mqtt.PING";
    ...
    private String          brokerHostName       = PokrData.preferenceBrokerHost;
    // taken from preferences
    //    topic we want to receive messages about
    //    can include wildcards - e.g.  '#' matches anything
    private String          topicName            = PokrData.preferenceBrokerTopic;

    // defaults - this sample uses very basic defaults for it's interactions
    //   with message brokers
    private int             brokerPortNumber     = PokrData.preferenceBrokerPort;
    ...
    {
        // pass a message received from the MQTT server on to the Activity U
    ...
    {
        NotificationManager nm = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);
        Notification notification = new Notification(R.drawable.pokr_launcher, alert,
                                                     System.currentTimeMillis());
